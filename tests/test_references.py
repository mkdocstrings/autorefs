...
def test_reference_implicit():
    ...
    run_references_test(
        ...
        source="This [Foo][].",
        output='<p>This <a class="autorefs internal" href="foo.html#Foo">Foo</a>.</p>',
    )
...
def test_reference_explicit_with_markdown_text():
    ...
    run_references_test(
        url_map={"Foo": "foo.html#Foo"},
        source="This [**Foo**][Foo].",
        output='<p>This <a class="autorefs internal" href="foo.html#Foo"><strong>Foo</strong></a>.</p>',
    )
...
def test_reference_implicit_with_code():
    ...
    run_references_test(
        url_map={"Foo": "foo.html#Foo"},
        source="This [`Foo`][].",
        output='<p>This <a class="autorefs internal" href="foo.html#Foo"><code>Foo</code></a>.</p>',
    )
...
def test_reference_with_punctuation():
    ...
    run_references_test(
        ...
        source='This [Foo&"bar][].',
        output='<p>This <a class="autorefs internal" href="foo.html#Foo&amp;&quot;bar">Foo&amp;"bar</a>.</p>',
    )
...
def test_reference_to_relative_path():
    ...
    run_references_test(
        ...
        source="This [zz][].",
        output='<p>This <a class="autorefs internal" href="../../foo.html#zz">zz</a>.</p>',
    )
...
def test_custom_required_reference():
    ...
    assert output == '[foo][bar] <a class="autorefs internal" href="ok.html#ok">ok</a>'
    assert unmapped == ["bar"]
...
def test_custom_optional_reference():
    ...
    output, unmapped = fix_refs(source, url_map.__getitem__)  # noqa: WPS609
    assert output == 'foo <a class="autorefs internal" href="ok.html#ok">ok</a>'
...
def test_custom_optional_hover_reference():
    ...
    output, unmapped = fix_refs(source, url_map.__getitem__)  # noqa: WPS609
    assert output == '<span title="bar">foo</span> <a class="autorefs internal" title="ok" href="ok.html#ok">ok</a>'
    assert unmapped == []  # noqa: WPS520
...
def test_external_references():
    ...
    output, unmapped = fix_refs(source, url_map.__getitem__)  # noqa: WPS609
    assert output == '<a class="autorefs external" href="https://example.com">example</a>'
    assert unmapped == []  # noqa: WPS520
